/**
 * `@nessie/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@nessie/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@nessie/plugin-sdk/ui";
 *
