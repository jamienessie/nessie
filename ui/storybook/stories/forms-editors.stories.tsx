...
import type { Agent, CompanySecret, EnvBinding, Project, RoutineVariable } from "@nessie/shared";
...
const validAdapterValues = {
  ...
  allowedCommands: ["pnpm --filter @nessie/ui typecheck", "pnpm build-storybook"],
