 ...
 *
 * Plugin bundles are built with `external: ["@nessie/plugin-sdk/ui", "react", "react-dom"]`,
 ...
 * - `import { ... } from "@nessie/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@nessie/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@nessie/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@nessie/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@nessie/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@nessie/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
