...
import { AGENT_DEFAULT_MAX_CONCURRENT_RUNS, supportedEnvironmentDriversForAdapter } from "@nessie/shared";
...
// Canonical type lives in @nessie/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@nessie/adapter-utils";
