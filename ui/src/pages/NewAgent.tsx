...
import { AGENT_ROLES, type AdapterEnvironmentTestResult } from "@nessie/shared";
...
import { DEFAULT_OPENCODE_LOCAL_MODEL, isValidOpenCodeModelId } from "@nessie/adapter-opencode-local";
