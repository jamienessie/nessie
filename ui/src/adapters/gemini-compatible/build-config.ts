...
// Mirror openrouter-compatible/build-config.ts. Both adapters take an
// API key + model + optional env bindings and emit the same shape.
...
export function buildGeminiCompatibleConfig(values: CreateConfigValues): Record<string, unknown> {
