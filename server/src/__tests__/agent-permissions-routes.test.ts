...
function registerModuleMocks() {
  vi.doMock("@nessie/adapter-opencode-local/server", async () => {
    const actual = await vi.importActual<typeof import("@nessie/adapter-opencode-local/server")>("@nessie/adapter-opencode-local/server");
    return {
      ...actual,
  ...
  vi.doMock("@nessie/shared/telemetry", () => ({
...
describe.sequential("agent permission routes", () => {
  beforeEach(() => {
    vi.resetModules();
    vi.doUnmock("@nessie/shared/telemetry");
    ...
    vi.doUnmock("@nessie/adapter-opencode-local/server");
    registerModuleMocks();
    vi.resetAllMocks();
